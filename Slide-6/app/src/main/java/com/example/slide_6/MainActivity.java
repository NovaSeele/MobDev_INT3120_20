...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        } else if (item.getItemId()==R.id.week4_1) {
            //open the week4_1 layout
            Intent intent = new Intent(this, Week4_1.class);
            startActivity(intent);
        } else if (item.getItemId()==R.id.week4_2) {
            Intent intent = new Intent(this, Week4_2.class);
            startActivity(intent);
        }
        return true;
    }
